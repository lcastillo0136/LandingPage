<template>
  <div class="box_general_2 add_bottom_45 d-flex card-columns flex-column profile-payment">
    ...
    <template v-if="!product">
      <h2 class="border border-danger rounded p-3 text-danger">
        Error en el modulo de pagos favor de informar al administrador del sistema.
      </h2>      
    </template>
  </div>
</template>
<script>
  ...
  import DetailsPayment from '@/view/findoctor/register/components/details-payment'
