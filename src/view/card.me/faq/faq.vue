        ...
        faq: {
          ...
          general: {
            ...
            questions: [{
              ...
              content: '<p>¡Claro!</p><p>En este enlace podrás ver la tarjeta digital de <a href="https://api.onlycards.me/@zibasoft" target="_blank">Zibasoft</a><br>O escaneando este código QR: <br> <img src="/img/zibasoft-qr.png" alt="Zibasoft" border="0" /></p>'
            }, {
              id: 5,
