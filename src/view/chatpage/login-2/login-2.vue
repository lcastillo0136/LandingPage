            ...
            <a-form-model ref="loginForm" :rules="rules" :model="form">
              ...
              <div class="form-group">
                <a-form-model-item prop="username">
                  ...
                  <a slot="help" href="#" @click.stop.prevent="closeForgot" v-if="forgot.open"><small>{{ $t('login.form.login_form') }}</small></a>
                </a-form-model-item>
              </div>
              ...
              <template  v-if="forgot.open">
                <div class="form-group text-center add_top_20">
                  <input class="btn_1 medium" type="submit" :loading="loading" :value="$t('login.form.recover')" @click.stop.prevent="handleRecover">
                </div>
              </template>
            </a-form-model>
          </div>
